...
//
///*predecessor:paraString definition*/
//
...
//	namesClean="";
//	variables=new vector <variable>;
//	terms=new vector <terms>;
//}
//
//predecessor::predecessor(string	tmplt,vector	<term>	Terms){
//	Template="tmplt";
//	numOfVars="";
//	namesClean="";
//	variables=new vector <variable>;
//	vector<term> Ter1(Terms);
//	terms=Ter1;
//	ParseTemplate();
//}
//
//predecessor::predecessor(string	tmplt,vector	<term>	Terms,vector <variable> Variables){
//	Template="tmplt";
//	numOfVars="";
//	namesClean="";
//	variables=new vector <variable>;
...
//}
//
///*End of predecessor:paraString definition*/
//
///*successor:paraString definition*/
//
//successor::successor(){
//	Template="";
//	numOfVars="";
//	namesClean ="";
//	variables = new vector <variable>;
//	sucVars=new vector<sucVar>;
//}
//
//successor::successor(string	tmplt,vector	<sucVar> SucVars){
//	Template="tmplt";
//	numOfVars="";
//	namesClean="";
//	variables=new vector <variable>;
//	vector<sucVar> Suc1(SucVars);
//	sucVars=Suc1;
//	ParseTemplate();
//}
//
//successor::successor(string	tmplt,vector	<sucVar> SucVars,vector <variable> Variables){
//	Template="tmplt";
//	numOfVars="";
//	namesClean="";
//	variables=new vector <variable>;
